...
describe('Service Tests', () => {
    ...
    describe('ContextDataBooster Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ContextDataBoosterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contexts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ContextDataBooster', () => {
