...
describe('Service Tests', () => {
    ...
    describe('ExecutionDataBooster Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ExecutionDataBoosterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/executions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ExecutionDataBooster', () => {
