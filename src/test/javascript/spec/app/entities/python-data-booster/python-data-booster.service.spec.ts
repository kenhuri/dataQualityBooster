...
describe('Service Tests', () => {
    ...
    describe('PythonDataBooster Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PythonDataBoosterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pythons';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PythonDataBooster', () => {
