...
describe('Service Tests', () => {
    ...
    describe('PickleDataBooster Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PickleDataBoosterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pickles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PickleDataBooster', () => {
