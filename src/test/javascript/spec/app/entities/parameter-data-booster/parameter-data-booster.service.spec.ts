...
describe('Service Tests', () => {
    ...
    describe('ParameterDataBooster Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParameterDataBoosterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/parameters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ParameterDataBooster', () => {
