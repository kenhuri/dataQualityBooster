package com.micropole.dqb.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("dataQualityBooster");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("dataQualityBooster");
        ...
        config.getMapConfigs().put("com.micropole.dqb.domain.*", initializeDomainMapConfig(jHipsterProperties));
